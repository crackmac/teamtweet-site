...
#$team_name = $_GET['var1']; 
$list_name = "secretsfromastylist";
$name1 = "secrets from a stylist";
$name2 = "sfas";
$name3 = "hgtv";
$name4 = "em_henderson";
...
<head>
  ...
  <title>Secrets From a Stylist Twitter Feed - HGTVs New Interior Design Show</title>
  <meta name="description" content="Follow the twitter chatter of Emily Henderson, HGTVs Design Star winner and host of Secrets From a Stylist and other Interior Design fans on teamtweet.net.">
  <meta name="author" content="Kevin Duane">
  <meta name="keywords" content="HGTV, Secrets From A Stylist, Emily Henderson, Design Star, SFAS, Interior Design">
...
<body>
  ...
  <div id="container">
	...
	<section id="intro">
		<header>
			<h2>Watch the tweets fly for Emily Henderson's new HGTV show Secrets From A Stylist.</h2>
		</header>
		<p>The Insiders are fans, bloggers, HGTV stars and happy recipients of Emily's hard work. Pillow Talk are tweeters who have nothing but LOVE for our Design Star. Watch out for the Raw Feed though because you'll never know who's going to say what.</p>
		<!-- <p><a href="#" class="hide">[hide]</a><a href="#" class="show">[show]</a></p> -->
	</section>
	
	<div id="content">
		<section>
			<header>
				<h3>Secrets From A Stylist: <a href="http://twitter.com/#!/em_henderson" target="_blank">@em_henderson</a>, <a href="http://twitter.com/#!/hgtv" target="_blank">@hgtv</a></h3>
			</header>
			<div class="tw-window01">
				...
				}).render().setList('crackmac', "secretsfromastylist").start();
				</script>
			</div>
