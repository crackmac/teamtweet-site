<?php 
$team_name01 = $_GET['var1']; 
$team_common_name01 = $_GET['var2'];
$team_name02 = $_GET['var3']; 
$team_common_name02 = $_GET['var4'];

$search1="\"$team_common_name01\" OR \"$team_name01\"";
$search2="\"$team_common_name02\" OR \"$team_name02\"";
$raw="\#marchmadness OR ncaa";

$score="$team_name01 from:marchmadness";
?>
